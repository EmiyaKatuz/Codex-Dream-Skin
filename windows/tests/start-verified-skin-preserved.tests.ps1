...
$renderedPayload = @'
{"installed":true,"version":"1.5.7","expectedVersion":"1.5.7",
"themeId":"preset-internet-angel-default","expectedThemeId":"preset-internet-angel-default",
"revision":"fixture-revision","expectedRevision":"fixture-revision",
"stylePresent":true,"homePresent":true,
...
foreach ($required in @('$verifyJson.installed', '$verifyJson.stylePresent',
  ...
  '$verifyJson.expectedVersion', '$verifyJson.expectedThemeId', '$verifyJson.expectedRevision')) {
